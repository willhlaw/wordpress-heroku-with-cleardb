		...
		function google_map_js_script() {
			...
			function createSidebarEntry(marker, locationData, searchData) {
				...
				if (locationData.distance.toFixed(1) != 'NaN') {
					...
					html += '<a class="result_directions" href="#" onclick="directions.computeDirections(null, dir_address, \'address\'); return false;">' + 'Add to Trip' + '</a>'; //Custom injection for GmapDirections so instead of new page, user can add the site as a stop / waypoint on the map
				}
				html += '</div>';
